...
function LineIconButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className="inline-flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-lg border-2 border-white p-0 outline-none shadow-none ring-0 focus:outline-none focus:ring-0"
      style={{ backgroundColor: '#06C755', boxShadow: 'none' }}
    >
      <FontAwesomeIcon
        icon={faLine}
        aria-hidden
        ...
        <div className={`grid gap-4 mb-4 ${isListen ? 'md:grid-cols-4' : 'md:grid-cols-3'}`}>
          <div>
            ...
            >
              ...
              <option value="projects">{GRADEBOOK_TOOL_LABELS.projects}</option>
            </select>
          </div>
          <div>
